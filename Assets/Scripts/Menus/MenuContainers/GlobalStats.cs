...
namespace Watermelon_Game.Menus.MenuContainers
{
    ...
    internal sealed class GlobalStats : ScrollRectBase
    {
        ...
        #region Properties
        /// <summary>
        /// Singleton of <see cref="GlobalStats"/>
        /// </summary>
        ...
        /// </summary>
        /// <param name="_Set">If true, sets the loaded values to their respective properties in <see cref="GlobalStats"/></param>
        ...
        /// <summary>
        /// Creates a new <see cref="StatsValues"/> object with the values of this <see cref="GlobalStats"/>
        /// </summary>
        /// <returns>A new <see cref="StatsValues"/> object with the values of this <see cref="GlobalStats"/></returns>
